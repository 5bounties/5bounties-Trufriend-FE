                    ...
                    item {
                        Card(modifier = Modifier
                            ...
                            Box(modifier = Modifier
                                ...
                                Image(painter = painterResource(id = R.drawable.verbalskills), contentDescription = "woman computer", modifier = Modifier.fillMaxWidth(), contentScale = ContentScale.Crop)
                            }
                        }
                    }
                    item { Spacer(modifier = Modifier.padding(16.dp)) }
                    item {
                        Text(text = "Verbal Skills", fontSize = 24.sp, fontWeight = FontWeight.SemiBold, modifier = Modifier.padding(horizontal = 16.dp))
                        Spacer(modifier = Modifier.padding(4.dp))
                        Text(text = "Keterampilan verbal untuk individu dengan autisme seringkali " +
                                "membutuhkan pendekatan yang individual dan disesuaikan. Beberapa " +
                                "individu mungkin mengalami tantangan dalam mengembangkan keterampilan" +
                                " berbicara dan berkomunikasi secara lisan, sementara yang lain " +
                                "mungkin menunjukkan kemajuan yang signifikan melalui terapi bicara, " +
                                "penggunaan PECS atau AAC, serta pendekatan yang melibatkan visual " +
                                "aids, social stories, dan latihan komunikasi sosial.", fontSize = 14.sp, modifier = Modifier.padding(horizontal = 16.dp), textAlign = TextAlign.Justify, lineHeight = 20.sp)
                    }
                    item { Spacer(modifier = Modifier.padding(16.dp)) }
                    item {
